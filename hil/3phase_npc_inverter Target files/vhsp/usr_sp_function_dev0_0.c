...
float  _inner_loop_beta__SS_V_GAINS [ ] = {  0 ,  0 ,  0 ,  0 ,  0 };
float  _inner_loop_beta__SS_I_GAINS [ ] = {  0 ,  0 ,  0 };
float  _inner_loop_beta__UV_BOUNDARY = 0;
float  _inner_loop_beta__UI_BOUNDARY = 0;
float  _inner_loop_beta__A = 0;
float  _inner_loop_beta__OMEGA0 = 0;
float  _inner_loop_beta__TS_20KHZ = 0;
float  _inner_loop_beta__uv = 0;
float  _inner_loop_beta__uv_bounded = 0;
float  _inner_loop_beta__xc_1_kminus1 = 0;
float  _inner_loop_beta__xc_2_kminus1 = 0;
float  _inner_loop_beta__xc_1 = 0;
float  _inner_loop_beta__xc_2 = 0;
float  _inner_loop_beta__err = 0;
float  _inner_loop_beta__ui = 0;
float  _inner_loop_beta__ui_bounded = 0;
...
double _inner_loop_beta__IN_ILF;
double _inner_loop_beta__IN_KR;
double _inner_loop_beta__IN_V0;
double _inner_loop_beta__IN_VC;

double _inner_loop_beta__OUT_ILF_REF;
double _inner_loop_beta__OUT_U_ALPHA;
...
void ReInit_user_sp_cpu0_dev0() {
    ...
    HIL_OutAO(0x4021, 0.0f);
    {
        ...
        _inner_loop_alpha__UV_BOUNDARY = 700 ;
    ...
    {
        _inner_loop_beta__SS_V_GAINS [ 0 ] = + 3.005202175747935e-02 ;
        _inner_loop_beta__SS_V_GAINS [ 1 ] = + 2.978384429593665e-01 ;
        _inner_loop_beta__SS_V_GAINS [ 2 ] = + 0 ;
        _inner_loop_beta__SS_V_GAINS [ 3 ] = + 4.332144964769132e-02 ;
        _inner_loop_beta__SS_V_GAINS [ 4 ] = - 4.386152786476110e-02 ;
        _inner_loop_beta__SS_I_GAINS [ 0 ] = + 1.072411193858177e+01 ;
        _inner_loop_beta__SS_I_GAINS [ 1 ] = - 2.938904663320472e-01 ;
        _inner_loop_beta__SS_I_GAINS [ 2 ] = 0 ;
        _inner_loop_beta__UV_BOUNDARY = 700 ;
        _inner_loop_beta__UI_BOUNDARY = 1000 ;
        _inner_loop_beta__A = 0.1 ;
        _inner_loop_beta__OMEGA0 = 376.991118431 ;
        _inner_loop_beta__TS_20KHZ = 0.00005 ;
        _inner_loop_beta__uv = 0 ;
        _inner_loop_beta__uv_bounded = 0 ;
        _inner_loop_beta__xc_1_kminus1 = 0 ;
        _inner_loop_beta__xc_2_kminus1 = 0 ;
        _inner_loop_beta__xc_1 = 0 ;
        _inner_loop_beta__xc_2 = 0 ;
        _inner_loop_beta__err = 0 ;
        _inner_loop_beta__ui = 0 ;
        _inner_loop_beta__ui_bounded = 0 ;
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    HIL_OutAO(0x4018, (float)_modulation_gain2__out);
    ...
    HIL_OutAO(0x4019, (float)_modulation_gain1__out);
    // Generated from the component: VSC1-FMeter.Freq
    HIL_OutAO(0x4025, (float)_vsc1_fmeter_pll_to_hz__out);
    ...
    HIL_OutAO(0x4029, (float)_vsc1_fmeter_power_meter__Pdc);
    // Generated from the component: VSC1-FMeter.POWER_PF
    HIL_OutAO(0x402a, (float)_vsc1_fmeter_power_meter__k_factor);
    // Generated from the component: VSC1-FMeter.POWER_Q
    HIL_OutAO(0x402b, (float)_vsc1_fmeter_power_meter__Qdc);
    // Generated from the component: VSC1-FMeter.POWER_S
    HIL_OutAO(0x402c, (float)_vsc1_fmeter_power_meter__apparent);
    ...
    HIL_OutAO(0x4026, (float)_vsc1_fmeter_i_rms_calc_rms__RMS1);
    // Generated from the component: VSC1-FMeter.IB_RMS
    HIL_OutAO(0x4027, (float)_vsc1_fmeter_i_rms_calc_rms__RMS2);
    // Generated from the component: VSC1-FMeter.IC_RMS
    HIL_OutAO(0x4028, (float)_vsc1_fmeter_i_rms_calc_rms__RMS3);
    // Generated from the component: VSC1-FMeter.VAB_RMS
    HIL_OutAO(0x402d, (float)_vsc1_fmeter_vll_rms_calc_rms__RMS1);
    // Generated from the component: VSC1-FMeter.VBC_RMS
    HIL_OutAO(0x402f, (float)_vsc1_fmeter_vll_rms_calc_rms__RMS2);
    // Generated from the component: VSC1-FMeter.VCA_RMS
    HIL_OutAO(0x4031, (float)_vsc1_fmeter_vll_rms_calc_rms__RMS3);
    // Generated from the component: VSC1-FMeter.VAn_RMS
    HIL_OutAO(0x402e, (float)_vsc1_fmeter_vln_rms_calc_rms__RMS1);
    // Generated from the component: VSC1-FMeter.VBn_RMS
    HIL_OutAO(0x4030, (float)_vsc1_fmeter_vln_rms_calc_rms__RMS2);
    // Generated from the component: VSC1-FMeter.VCn_RMS
    HIL_OutAO(0x4032, (float)_vsc1_fmeter_vln_rms_calc_rms__RMS3);
...
//////////////////////////////////////////////////////////////////////////
    ...
    HIL_OutAO(0x401a, (float)_steady_state__out);
    // Generated from the component: TEST_FLAG_FB
    HIL_OutAO(0x401b, (float)_test_flag__out);
    ...
    HIL_OutAO(0x4022, (float)_meas_clarke__OUT_VC_AB0[0]);
    HIL_OutAO(0x4023, (float)_meas_clarke__OUT_VC_AB0[1]);
    HIL_OutAO(0x4024, (float)_meas_clarke__OUT_VC_AB0[2]);
    ...
    HIL_OutAO(0x401f, (float)_ref_clarke__OUT_V0_AB0[0]);
    HIL_OutAO(0x4020, (float)_ref_clarke__OUT_V0_AB0[1]);
    HIL_OutAO(0x4021, (float)_ref_clarke__OUT_V0_AB0[2]);
    ...
    {
        _inner_loop_alpha__uv = - ( _inner_loop_alpha__SS_V_GAINS [ 0 ] * _inner_loop_alpha__IN_ILF ) - ( _inner_loop_alpha__SS_V_GAINS [ 1 ] * _inner_loop_alpha__IN_VC ) - ( _inner_loop_alpha__SS_V_GAINS [ 2 ] * _inner_loop_alpha__ui_bounded ) - ( _inner_loop_alpha__SS_V_GAINS [ 3 ] * _inner_loop_alpha__xc_1 ) - ( _inner_loop_alpha__SS_V_GAINS [ 4 ] * _inner_loop_alpha__xc_2 ) ;
    ...
    // Generated from the component: INNER_LOOP_BETA
    _inner_loop_beta__IN_ILF = _bus_selector5__out;
    _inner_loop_beta__IN_KR = _kr__out;
    _inner_loop_beta__IN_V0 = _bus_selector4__out;
    _inner_loop_beta__IN_VC = _bus_selector6__out;
    {
        _inner_loop_beta__uv = - ( _inner_loop_beta__SS_V_GAINS [ 0 ] * _inner_loop_beta__IN_ILF ) - ( _inner_loop_beta__SS_V_GAINS [ 1 ] * _inner_loop_beta__IN_VC ) - ( _inner_loop_beta__SS_V_GAINS [ 2 ] * _inner_loop_beta__ui ) - ( _inner_loop_beta__SS_V_GAINS [ 3 ] * _inner_loop_beta__xc_1 ) - ( _inner_loop_beta__SS_V_GAINS [ 4 ] * _inner_loop_beta__xc_2 ) ;
        _inner_loop_beta__uv_bounded = _inner_loop_beta__uv ;
        if ( ( _inner_loop_beta__uv * _inner_loop_beta__uv ) / sqrt ( _inner_loop_beta__uv * _inner_loop_beta__uv ) >= _inner_loop_beta__UV_BOUNDARY ) _inner_loop_beta__uv_bounded = _inner_loop_beta__UV_BOUNDARY * _inner_loop_beta__uv / sqrt ( _inner_loop_beta__uv * _inner_loop_beta__uv ) ;
        _inner_loop_beta__err = _inner_loop_beta__IN_V0 - _inner_loop_beta__IN_VC ;
        _inner_loop_beta__ui = ( _inner_loop_beta__IN_KR * _inner_loop_beta__uv_bounded ) - ( _inner_loop_beta__SS_I_GAINS [ 0 ] * _inner_loop_beta__IN_ILF ) - ( _inner_loop_beta__SS_I_GAINS [ 1 ] * _inner_loop_beta__IN_VC ) - ( _inner_loop_beta__SS_I_GAINS [ 2 ] * _inner_loop_beta__ui ) ;
        _inner_loop_beta__ui_bounded = _inner_loop_beta__ui ;
        if ( ( _inner_loop_beta__ui * _inner_loop_beta__ui ) / sqrt ( _inner_loop_beta__ui * _inner_loop_beta__ui ) >= _inner_loop_beta__UI_BOUNDARY ) _inner_loop_beta__ui_bounded = _inner_loop_beta__UI_BOUNDARY * _inner_loop_beta__ui / sqrt ( _inner_loop_beta__ui * _inner_loop_beta__ui ) ;
        _inner_loop_beta__xc_1_kminus1 = _inner_loop_beta__xc_1 ;
        _inner_loop_beta__xc_2_kminus1 = _inner_loop_beta__xc_2 ;
        _inner_loop_beta__xc_1 = 0.0 * _inner_loop_beta__xc_1 + 1 * _inner_loop_beta__xc_2_kminus1 ;
        _inner_loop_beta__xc_2 = - exp ( - _inner_loop_beta__A * _inner_loop_beta__TS_20KHZ ) * _inner_loop_beta__xc_1_kminus1 + 2 * exp ( - 2 * _inner_loop_beta__A * _inner_loop_beta__TS_20KHZ ) * cos ( _inner_loop_beta__OMEGA0 * _inner_loop_beta__TS_20KHZ ) * _inner_loop_beta__xc_2_kminus1 + _inner_loop_beta__err ;
        _inner_loop_beta__OUT_U_ALPHA = + _inner_loop_beta__ui_bounded ;
        _inner_loop_beta__OUT_ILF_REF = _inner_loop_beta__uv_bounded ;
    }
    ...
    _geo_pwm__IN_VDC_2 = _dc_bus_vc2_va1__out;
    {
        ...
        _geo_pwm__v0 = computeV0 ( _geo_pwm__i0 , _geo_pwm__IN_M [ 2 ] , _geo_pwm__IN_M [ 0 ] , _geo_pwm__IN_M [ 1 ] , _geo_pwm__IN_ILF [ 0 ] , _geo_pwm__IN_ILF [ 1 ] , _geo_pwm__IN_ILF [ 2 ] ) ;
    ...
    // Generated from the component: U
    HIL_OutAO(0x401c, (float)_geo_pwm__OUT_V_AB0[0]);
    HIL_OutAO(0x401d, (float)_geo_pwm__OUT_V_AB0[1]);
    HIL_OutAO(0x401e, (float)_geo_pwm__OUT_V_AB0[2]);
    ...
    // Generated from the component: MOD
    HIL_OutAO(0x4015, (float)_inv_clarke__OUT_V[0]);
    HIL_OutAO(0x4016, (float)_inv_clarke__OUT_V[1]);
    HIL_OutAO(0x4017, (float)_inv_clarke__OUT_V[2]);
